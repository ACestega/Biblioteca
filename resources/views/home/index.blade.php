                            ...
                            <table class="w-full text-left">
                                <thead class="bg-gray-50">
                                    <tr>
                                        ...
                                        <th class="py-3 px-4 font-semibold text-gray-700">Disponibilidad</th>
                                ...
                                <tbody>
                                    ...
                                    <tr class="border-t hover:bg-gray-50">
                                        <td class="px-4 py-2 border-b text-center">{{ $libro->nombre }}</td>
                                        <td class="px-4 py-2 border-b text-center">{{ $libro->isbn }}</td>
                                        <td class="px-4 py-2 border-b text-center">{{ $libro->autor }}</td>
                                        <td class="px-4 py-2 border-b text-center">{{ $libro->categoria->nombre }}</td>
                                        <td class="px-4 py-2 border-b text-center">
                                            @if($libro->estatus == 0)
                                            <span class="bg-green-100 text-green-800 px-2 py-1 rounded text-xs font-medium">Disponible</span>
                                            @else
                                            <span class="bg-red-100 text-red-800 px-2 py-1 rounded text-xs font-medium">Prestado</span>
                                            @endif
                                        </td>
                                        <td class="py-3 px-4">
